...
<div class="rtcl-post-details rtcl-post-section">
	...
	<div class="form-group">
		...
		<input type="text"
			<?php echo $title_limit ? 'data-max-length="'.$title_limit.'" maxlength="' . $title_limit . '"' : ''; ?>
			   class="form-control"
	...
	<?php if ( ! in_array( 'description', $hidden_fields ) ): ?>
		<div class="form-group" <?php echo $description_limit ? 'data-max-length="'.$description_limit.'"' : ''; ?>>
			...
			if ( 'textarea' == $editor ) { ?>
				<textarea
					...
					name="description"
					class="form-control"
                        <?php echo $description_limit ? 'data-max-length="'.$description_limit.'" maxlength="' . $description_limit . '"' : ''; ?>
