...
class ListingRenewalReminderEmailToOwner extends RtclEmail
{

    function __construct() {
        $this->db = true;
        $this->id = 'renewal_reminder';
        $this->template_html = 'emails/listing-renewal-reminder-email-to-owner';
    ...
    public function get_default_subject() {
        return esc_html__('[{site_title}] {listing_title} - Renewal reminder', 'classified-listing');
    }
    ...
    public function get_default_heading() {
        return esc_html__('Renewal reminder', 'classified-listing');
    }
    ...
    public function trigger($listing_id, $listing = false) {
        ...
        if (is_a($listing, Listing::class)) {
            ...
            $this->placeholders = wp_parse_args(array(
                ...
                '{renewal_link}'    => Functions::is_payment_disabled() ? Link::get_my_account_page_link('listings') : Link::get_listing_promote_page_link($listing->get_id()),
